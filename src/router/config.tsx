...
export const BENEFICIARY_JOURNEY = `${JOURNEY}beneficiary/`;
export const BENEFICIARY_MONEY_TRANSFER_JOURNEY = `${JOURNEY}beneficiary/moneytransfer/`;
...
/* Add - moneytransfer local journey*/
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL = `${BENEFICIARY_MONEY_TRANSFER_JOURNEY}local/`;
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL_ACCOUNTDETAILS = `${BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL}account`;
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL_BANKDETAILS = `${BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL}bank`;
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL_BENEFICIARYDETAILS = `${BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL}beneficiary`;
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL_AUTHENTICATION = `${BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL}authentication`;
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL_CONFIRMATION = `${BENIFICIARY_MONEY_TRANSFER_JOURNEY_LOCAL}confirmation`;

/* Add - moneytransfer within mashreq journey */
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_WITHIN = `${BENEFICIARY_MONEY_TRANSFER_JOURNEY}within/`;
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_WITHIN_BENEFICIARYDETAILS = `${BENIFICIARY_MONEY_TRANSFER_JOURNEY_WITHIN}beneficiary`;
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_WITHIN_AUTHENTICATION = `${BENIFICIARY_MONEY_TRANSFER_JOURNEY_WITHIN}authentication`;
export const BENIFICIARY_MONEY_TRANSFER_JOURNEY_WITHIN_CONFIRMATION = `${BENIFICIARY_MONEY_TRANSFER_JOURNEY_WITHIN}confirmation`;
