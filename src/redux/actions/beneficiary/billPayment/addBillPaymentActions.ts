 ...
 * Actions Types
 */
export const FETCH_BENEFICIARY_SERVICE_TYPES =
  "FETCH_BENEFICIARY_SERVICE_TYPES";
export const FETCH_BENEFICIARY_SERVICE_TYPES_SUCCESS =
  "FETCH_BENEFICIARY_SERVICE_TYPES_SUCCESS";
export const FETCH_BENEFICIARY_SERVICE_TYPES_FAILURE =
  "FETCH_BENEFICIARY_SERVICE_TYPES_FAILURE";
