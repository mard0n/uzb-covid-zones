              ...
              <FormGroup>
                <FormControl className={inputBox}>
                  <TextField
                    ...
                    label={t("kyc.placeholderText.loginPlaceholder")}
                    onChange={handleChange("username")}
                    aria-describedby={t("kyc.placeholderText.loginPlaceholder")}
                    inputProps={{
                      "aria-label": t("kyc.placeholderText.loginPlaceholder"),
                      maxLength: 80
                    }}
                  />
                </FormControl>
