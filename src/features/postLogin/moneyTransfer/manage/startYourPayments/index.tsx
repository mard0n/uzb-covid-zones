...
import { Box, UnderlineText, H2, Button, SectionSplitter, CircularProgress } from "@mashreq-digital/ui";
...
const StartPayments = (props: StartPaymentsProps) => {
  ...
  const onChangeFromAcount = (item: any) => {
    ...
    if(transfer.hasOwnProperty("fromAccount") && transfer.hasOwnProperty("toAccount")){
