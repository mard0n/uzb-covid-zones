      ...
      <SectionSplitter
        ...
        top={
          <>
            ...
            <Box mt={4} mb={4}>
              <H4>The Payments is for</H4>
            </Box>

            <SelectPopup
              title="Select Purpose of Payment"
            ...
            <Box mt={8} mb={4}>
              <H4>Who pays the payment charges?</H4>
            </Box>
            <Grid container xs={12} sm={12} lg={12} xl={12} md={12}>
              <Grid item xs={8} sm={8} lg={8} xl={8} md={8}>
                <SelectBox
                  ...
                  title="Only the receiver"
                  content="The receiver pays the charges out of this transfer"
                />
                ...
                <SelectBox
                  ...
                  title="Only the sender"
                  content="To pay the charges upfront"
                />
                ...
                <SelectBox
                  ...
                  title="Shared between sender & receiver"
                  content={"Both parties share the charges"}
                />
              </Grid>
              ...
              <Grid item lg={4} xl={4} md={4} sm={4} xs={4}>
                <Box style={{ width: "300px" }}>
                  <InfoCard
                    icon={QuestionCircle}
                    title="Payment charges for locale UAE transfers"
                    fullWidth
                    content={
                      <Caption>
                        Not expected from Praveen. Please note that the
                        correspondent bank may deduct charges from remittance
                        amount irrespective of the charge method selected.
                      </Caption>
                    }
                  />
                </Box>
            ...
            {purposeModel && (
              <Modals
                heading={<H4>Select Purpose of Paymentt</H4>}
                open={purposeModel}
                onBackdropClick={(e) => {
                  console.log(e);
                }}
