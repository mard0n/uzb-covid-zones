...
/* Account Loan List */
export const PRODUCT_SUMMARY_ACC_LOAN_DEP_ENDPOINT =
  "/mob-dashboard/v1/summary/account-loan-deposit";
export const PRODUCT_SUMMARY_CARD_ENDPOINT = "/mob-dashboard/v1/summary/cards";
export const PRODUCT_SUMMARY_REWARDS_ENDPOINT =
  "/mob-dashboard/v1/summary/rewards";
...
/* MANAGE BENEFICIARY */
/*Money Transfer*/
export const MONEY_TRANSFER_IBAN =
  "/beneficiary-core-service/v1/beneficiary/search"; //?category="biller" / "utility"
/* Beneficiary */
// const Beneficiary_bill_payment
export const BENEFICIARY_SERVICE_TYPES_ENDPOINT =
  "/beneficiary-core-service/v1/beneficiary/service-type?category=biller"; //?category="biller" / "utility"
export const MY_BILL_PAYMENT_BENEFICIARES_ENDPOINT =
  "/beneficiary-core-service/v1/beneficiary/grouped?size=200"; //?size=20
